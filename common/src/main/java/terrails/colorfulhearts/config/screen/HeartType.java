...
public enum HeartType {
    ...
    public ResourceLocation getBaseSprite(boolean hardcore, boolean highlight, boolean half) {
        return new ResourceLocation(CColorfulHearts.MOD_ID, "heart/" + (this.isHealthType() ? "health" : "absorbing") + this.getEffectName() + "/" + (hardcore ? "hardcore_" : "") + (half ? "half" : "full") + (highlight ? "_blinking" : ""));
    }
